...
export type TransferScope = 'table' | 'database' | 'server'

export type TransferProfileKind = 'backup' | 'migrate' | 'export' | 'import'

export type TransferProfile = {
  id: string
  name: string
  kind: TransferProfileKind
  scope: TransferScope
  connectionId: string
  targetConnectionId?: string
...
export type TransferJobStatus = 'queued' | 'running' | 'paused' | 'completed' | 'failed' | 'cancelled'
