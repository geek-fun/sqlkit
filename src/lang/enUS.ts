  ...
  pages: {
    ...
    settings: {
      ...
      mcp: {
        ...
        restartSuccess: 'MCP bridge restarted successfully',
        restartFailed: 'Restart failed',
        restartFailedDetail: 'Failed to restart the MCP bridge',
        restartTimeout: 'MCP bridge failed to start within 60 seconds',
        shuttingDown: 'Shutting down...',
        starting: 'Starting...',
        autoStart: 'Auto-start',
        autoStartDesc: 'Start the MCP bridge automatically when app launches',
        permissionMode: 'Permission Mode',
        permissionModeDesc: 'Control what MCP clients can do through the bridge',
        modeReadOnly: 'Read-only',
        modeReadOnlyDesc: 'Queries only, no modifications',
        modeDataReadWrite: 'Data read/write',
        modeDataReadWriteDesc: 'CRUD allowed, no schema changes',
        modeFullAccess: 'Full access',
        modeFullAccessDesc: 'All operations permitted',
        confirmDestructive: 'Confirm Destructive',
        confirmDestructiveDesc: 'Require explicit confirmation before executing destructive operations (DROP, TRUNCATE, DELETE, etc.)',
        allowlist: 'Connection Allowlist',
        allowlistDesc: 'Select which connections MCP clients can access. Leave empty to allow all.',
        allowlistEmpty: 'No connections selected — all connections are accessible',
        connectionOverrides: 'Connection Overrides',
        overrideReadOnly: 'Read-only',
        overrideReadOnlyDesc: 'Force read-only access for this connection regardless of the global mode',
  ...
  components: {
    serverForm: {
      ...
      placeholders: {
        ...
        encryptionKey: 'Enter encryption passphrase',
