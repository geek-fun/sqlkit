export const enUS = {
  ...
  transfer: {
    launcher: {
      ...
      targetTablePlaceholder: 'schema.table or table',
      dropTargetFirst: 'Drop target objects first',
      savePreset: 'Save current',
      presetNamePrompt: 'Enter preset name:',
      startSuccess: 'Task started',
      jobStarted: 'Job has been added to the queue.',
      startFailed: 'Task failed to start',
      jobsRunning: '{count} jobs running',
      allJobsCompleted: 'All jobs completed',
      noRunningJobs: 'No running jobs',
      noHistoryJobs: 'No history',
      tabs: {
        running: 'Running',
        history: 'History',
      },
      actions: {
        backup: {
          title: 'Backup',
          desc: 'Export database to a file',
          start: 'Start Backup',
        },
        restore: {
          title: 'Restore',
          desc: 'Import from a backup file',
          start: 'Start Restore',
        },
        migrate: {
          title: 'Migrate',
          desc: 'Transfer to another server',
          start: 'Start Migrate',
        },
        export: {
          title: 'Export',
          desc: 'Export table data to CSV/Excel',
          start: 'Start Export',
        },
      },
    },
    ...
    surface: {
      quickExport: {
        title: 'Quick export',
        subtitle: 'Export this table in one step',
        format: 'Format',
        columns: 'Columns',
      ...
      backupDatabase: {
        ...
        subtitle: 'Back up selected tables from this database',
        ...
        submit: 'Start backup',
        cancel: 'Cancel',
        jobName: 'Database backup: {db}',
      },
      backupServer: {
        title: 'Backup server',
        subtitle: 'Back up selected databases, schemas, and tables',
        selectObjects: 'Select objects',
        options: 'Backup options',
        destination: 'Destination',
        parallelism: 'Parallel jobs',
        review: 'Review',
        submit: 'Start backup',
        cancel: 'Cancel',
      ...
      migrateDatabase: {
        ...
        subtitle: 'Move this database to a target connection',
        source: 'Source',
        target: 'Target',
        mapping: 'Mapping',
      ...
      migrateServer: {
        ...
        subtitle: 'Migrate selected objects to another server',
        source: 'Source',
        target: 'Target',
        selectObjects: 'Select objects',
        options: 'Migration options',
    ...
    drawer: {
      collapsed: '{n} jobs · {percent}%',
      expanded: 'Transfer jobs',
      jobsRunning: '{n} running',
      aboutNMinutes: 'about {n} minutes left',
      aboutNSeconds: 'about {n} seconds left',
      completed: 'Completed',
      failed: 'Failed',
      cancelled: 'Cancelled',
      cancel: 'Cancel',
      show: 'Show in Activity Center',
      dismiss: 'Dismiss',
      pin: 'Pin',
    },
    tree: {
    ...
    activityCenter: {
      ...
      empty: {
        ...
        history: 'No transfer history yet',
    ...
    contextMenu: {
      ...
      copyTableTo: 'Copy table to...',
    },
    partial: {
      success: 'Partial success: {ok} of {total} {unit} completed',
      cancelledMidway: 'Cancelled midway: {ok} of {total} {unit} completed',
    },
    errors: {
      profileLoadFailed: 'Failed to load transfer profile',
      profileSaveFailed: 'Failed to save transfer profile',
      jobStartFailed: 'Failed to start transfer job',
      noObjectsSelected: 'Select at least one object to continue',
    },
    notifications: {
      jobCompleted: '{name} completed',
      jobFailed: '{name} failed: {error}',
    },
    export: {
      step: {
        source: 'Source',
